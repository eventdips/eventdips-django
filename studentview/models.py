...
class Registrations(models.Model):
	...
	rej_reason = models.TextField(null=True,default="Sorry, your application has not been accepted.") #Only filled when Event is confirmed and Student has been rejected.
